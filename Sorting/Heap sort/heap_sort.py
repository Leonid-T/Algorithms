'''
В пирамидальной сортировке для упорядочения элементов используется
невозрастающая пирамида. Вершина построенной пирамиды перемещается на
соответствующую позицию массива с последующим восстановлением свойств пирамиды.
'''
