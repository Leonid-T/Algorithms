'''
Очередь с приоритетами представляет собой структуру данных, предназначенную для
обслуживания множества, с которым связано множество ключей, которые отражают
приоритет элементов из исходного множества.
В структуре Heap представлена реализация очереди с приоритетами на основе
невозрастающей пирамиды, оперирующей значениями ключей.
'''
