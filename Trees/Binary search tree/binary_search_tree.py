'''
Бинарное дерево поиска представляет из себя связанную структуру данных, в
которой каждый из узлов является объектом, имеющим левого и правого потомков.
При этом ключ левого потомка меньше, а ключ правого потомка больше ключа
исходного узла.
'''
