'''
B-деревья представляют собой сбалансированные деревья поиска, созданные для
эффективной работы с дисковой памятью. В отличие от бинарных деревьев поиска,
узлы данных деревьев могут иметь множество ключей и множество потомков.
'''
